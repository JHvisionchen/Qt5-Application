...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NetworkInformation_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NetworkInformation_t qt_meta_stringdata_NetworkInformation = {
    {
QT_MOC_LITERAL(0, 0, 18), // "NetworkInformation"
QT_MOC_LITERAL(1, 19, 10), // "slotDetail"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "NetworkInformation\0slotDetail\0"
};
...
const QMetaObject NetworkInformation::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NetworkInformation.data,
      qt_meta_data_NetworkInformation,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NetworkInformation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NetworkInformation.stringdata0))
